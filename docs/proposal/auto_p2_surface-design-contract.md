...
- Shared UI package：`packages/ui` 已有 `Button`、`Input`、`Textarea`、`Badge`、`EmptyState`、`Skeleton`、`Markdown` 等基础件，`packages/app/src/index.css` 也引入了 `@hone-financial/ui/styles`。
